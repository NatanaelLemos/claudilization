...
function decisionPrompt(doctrine: string, state: unknown): string {
  return [
    ...
    `Work points come ONLY from the player's own completed prompts (their real`,
    `Claude Code usage); no order, settler, or building can earn them, and no`,
    `catastrophe can take them away.`,
    ``,
